...
import HeroWithProof from '@/components/mockups/HeroWithProof';
import ValidationSection from '@/components/mockups/ValidationSection';
...
export default function TrustSignalsMockup() {
  ...
  return (
    <main className="min-h-screen bg-bg">
      ...
      <div className="fixed top-[54px] left-0 right-0 z-[99] bg-[rgba(196,135,90,0.12)] border-b border-[rgba(196,135,90,0.2)] backdrop-blur-[8px]">
        <div className="max-w-[1440px] mx-auto px-4 md:px-8 lg:px-12 py-2 flex items-center justify-between">
          <div className="font-mono text-[10px] md:text-[11px] text-copper tracking-[0.06em]">
            MOCKUP 1: Trust Signals (proof bar + validation section + community stats)
          </div>
      ...
      {/* CHANGED: Hero with community proof bar */}
      <HeroWithProof />

      {/* NEW: Validation section between hero and filters */}
      <ValidationSection />
